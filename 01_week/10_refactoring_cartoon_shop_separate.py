...
def get_output_data(order_data_list):
    ...
    for order_data in order_data_list:
        ...
        for cartoon_consumption_history in order_data["cartoon_consumption_histories"]:  # 각 만화 소비 기록별 for문
...
def calculate_point_from_histories(cartoon_info, order_history):
    point = 0  # 포인트 계산하기
    for cartoon_consumption_history in order_history["cartoon_consumption_histories"]:  # 각 만화 소비 기록별 for문
        point += caclulate_point(cartoon_consumption_history, cartoon_info)
    return point


def caclulate_point(cartoon_consumption_history, cartoon_info):
    point = 0
